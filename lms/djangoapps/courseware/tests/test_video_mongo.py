...
class TestVideo(BaseTestXmodule):
    ...
    def test_update_field(self):
        ...
        self.item_descriptor.location = None
        self.item_descriptor.update_field('source')
        self.assertDictEqual(
            self.item_descriptor.editable_metadata_fields,
            expected_fields
        ...
        # ValueError
        self.item_descriptor.update_field('source', value=[])
        self.assertDictEqual(
            self.item_descriptor.editable_metadata_fields,
            expected_fields
        )
...
class VideoBackwardsCompatibilityTestCase(TestVideo):
    ...
    def test_source_not_in_html5sources(self):
        ...
        self.assertFalse(fields['download_video']['explicitly_set'])
    ...
    def test_source_in_html5sources(self):
        ...
        self.assertListEqual(fields['download_video']['value'], ['true'])
    ...
    def test_source_is_empty(self):
        ...
        self.assertNotIn('source', fields)
        self.assertListEqual(fields['download_video']['value'], [])
